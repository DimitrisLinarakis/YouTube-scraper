...
class YoutubeSpider(Spider):
    ...
    #file_directory = "C:\\Users\\steve\\OneDrive\\Υπολογιστής\\Πτυχιακή\\YouTubeScraperGit\\youtube-crawler-master\\yt\\resources\\BusinessChannels.json"
    ...
    API_keys = {}
    API_keys_file = "C:\\Users\\steve\\OneDrive\\Υπολογιστής\\Πτυχιακή\\youtube_scraper\\youtube-crawler-master\\yt\\resources\\APIkeys.json"
    ...
    video_categories = {}
    video_categories_file = 'C:\\Users\\steve\\OneDrive\\Υπολογιστής\\Πτυχιακή\\youtube_scraper\\youtube-crawler-master\\yt\\resources\\CategoryIDs.json'
